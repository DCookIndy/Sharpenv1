angular.module('sharpenApp', ['ionic', 'firebase', 'sharpenApp.controllers', 'chart.js', 'ngCordova'])
...
.run(function($ionicPlatform, $rootScope, $firebaseAuth, $firebase, $window, $ionicLoading) {
    $ionicPlatform.ready(function() {
        ...
        $rootScope.baseUrl = 'https://sweltering-fire-3441.firebaseio.com/';
...
.config(function($stateProvider, $urlRouterProvider) {
    $stateProvider
        ...
        .state('bucket.missed', {
            ...
            views: {
                'bucket-missed': {
                    templateUrl: 'templates/bucket-missed.html',
